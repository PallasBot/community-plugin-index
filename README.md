...
| 名称 | ID | 作者 | 说明 |
| --- | --- | --- | --- |
| [牛牛互动](https://github.com/TogetsuDo/pallas-community-plugin-interact) | `interact` | [@TogetsuDo](https://github.com/TogetsuDo) | 名片点赞、戳一戳回图、群主头衔与刷屏管理。社区插件开发示范。 |
...
| [明日方舟B站动态](https://github.com/Blackish-Red/pallas-plugin-bilibili) | `bilibili_dynamic` | [@Blackish-Red](https://github.com/Blackish-Red) | 订阅明日方舟官方 B站动态并推送到当前群。 |
